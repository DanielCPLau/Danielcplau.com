      ...
      <nav className={fixedTop}>
        <div className='container-fluid'>
          <ul style={ulnav}>
            ...
            <a href="https://docs.google.com/document/d/1u1gEMXYhvON1EwD3SROZMKFB4Y45e4-JDfA0ndcSR6U/edit?usp=sharing" target="_blank"><li style={navbarli}><div style={navfont} href="#about">RESUME</div></li></a>
